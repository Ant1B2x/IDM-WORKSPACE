...
public class ResourceItemProvider extends ProcessElementItemProvider {
	...
	/**
	 * This adds a property descriptor for the Nb Available Resources feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNbAvailableResourcesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_nbAvailableResources_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_nbAvailableResources_feature", "_UI_Resource_type"),
				 SimplepdlPackage.Literals.RESOURCE__NB_AVAILABLE_RESOURCES,
				 true,
				 false,
				 false,

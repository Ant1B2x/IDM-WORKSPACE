...
public class PDL3Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL3GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getProcessAccess().getWorkDefinitionsAssignment_3_0(), "rule__Process__WorkDefinitionsAssignment_3_0");
			builder.put(grammarAccess.getProcessAccess().getWorkSequencesAssignment_5_0(), "rule__Process__WorkSequencesAssignment_5_0");
			...
			builder.put(grammarAccess.getGuidanceAccess().getTexteAssignment(), "rule__Guidance__TexteAssignment");
		}
	}

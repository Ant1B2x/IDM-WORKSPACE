...
public class InternalPDLParser extends AbstractInternalContentAssistParser {
    ...
    // InternalPDL.g:456:1: rule__WorkDefinition__Group__0__Impl : ( 'task' ) ;
    public final void rule__WorkDefinition__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL.g:460:1: ( ( 'task' ) )
            // InternalPDL.g:461:1: ( 'task' )
            {
            // InternalPDL.g:461:1: ( 'task' )
            // InternalPDL.g:462:2: 'task'
            {
    ...
    // InternalPDL.g:807:1: rule__WorkSequence__Group__0__Impl : ( 'dep' ) ;
    public final void rule__WorkSequence__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalPDL.g:811:1: ( ( 'dep' ) )
            // InternalPDL.g:812:1: ( 'dep' )
            {
            // InternalPDL.g:812:1: ( 'dep' )
            // InternalPDL.g:813:2: 'dep'
            {
